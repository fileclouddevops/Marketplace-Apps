...
| **Configuration** | **Description** |
|-------------------|-----------------|
| **Select an Image** | Ubuntu 20.04 and Ubuntu 18.04 are currently the only images supported by the FileCloud Marketplace App, and it is pre-selected on the Linode creation page. *Required* |
